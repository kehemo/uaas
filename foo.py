...
class Config:
    ...
    def __init__(
        ...
        self.target_kl = (
            target_kl  # target KL divergence for early stoping train_ac_iters for PPO
        )
        ...
        self.use_discounted_reward = (
            use_discounted_reward  # whether use discounted reward or not.
        )
